...
CREATE TABLE `Os` (
    ...
    `latitude` DOUBLE NULL DEFAULT -22.703024167060327,
    `longitude` DOUBLE NULL DEFAULT -46.99293384579572,
...
-- AddForeignKey
ALTER TABLE `Comentario` ADD CONSTRAINT `Comentario_colaborador_fkey` FOREIGN KEY (`colaborador`) REFERENCES `Colaborador`(`matricula`) ON DELETE CASCADE ON UPDATE CASCADE;
