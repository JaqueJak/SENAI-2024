...
int main(){
    ...
    while(1){
        ...
        if(opcao == 1){
        	...
        	while(1){
		        printf("|Digite 1 para Inserir um n?mero|\n|Digite 2 para Remover um n?mero|\n|Digite 0 para encerrar		|\n");
		        printf("|===============================|\n");
		        printf("FILA\n");
				printf("Insira a opção desejada: ")	;
		        scanf("%d", &opcao);
			...
			while(1){
			    printf("|Digite 1 para Inserir um numero|\n|Digite 2 para Remover um numero|\n|Digite 3 para Remover um index |\n|Digite 0 para encerrar		|\n");
			    printf("|===============================|\n");
			    printf("LISTA\n");
				printf("Insira a opçao desejada: ")	;
			    scanf("%d", &opcao);
				...
				if(opcao == 1){
		        	...
		        	printf("\nDigite a posição index do numero desejado:");
		            scanf("%d", &num);
		            printf("\n");
		            slice(num);
		            system("cls");
